...
nb4 = {
 "cells": [
  ...
  {"cell_type":"code","execution_count":None,"metadata":{},"outputs":[],"source":[
    "!pip install -q rapidfuzz transformers peft accelerate pillow bitsandbytes qwen-vl-utils\n",
  ...
  {"cell_type":"code","execution_count":None,"metadata":{},"outputs":[],"source":[
    ...
    "    \n",
    "    # Map doc_id to image_path from manifest\n",
    "    doc_paths = {}\n",
    ...
    "            doc_paths[item['doc_id']] = img_path\n",
    "            \n",
    "    field_scores   = {f: [] for f in EVAL_FIELDS}\n",
    "    insw_correct   = []\n",
    "\n",
    "    print('\\n=== MEMULAI EVALUASI REAL INFERENCE ===\\n')\n",
    "\n",
    "    for doc_key, gt_doc in gt_data.items():\n",
    "        img_path = doc_paths.get(doc_key)\n",
    ...
    "        \n",
    "        # Simple heuristic for INSW detection\n",
...
with open(r'c:\tradeflow-ai\tools\kaggle\nb4_eval.ipynb', 'w', encoding='utf-8') as f:
    json.dump(nb4, f, indent=1)

print("nb4_eval.ipynb rewritten with real inference code")
