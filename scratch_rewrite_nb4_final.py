...
notebook_path = Path("c:/tradeflow-ai/tools/kaggle/nb4_eval.ipynb")
 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    \n",
    "    with torch.no_grad():\n",
    "        # INCREASED max_new_tokens to prevent truncation on long lists\n",
    ...
    "    )[0]\n",
    "    \n",
    "    # ROBUST JSON PARSING (Greedy match to handle nested dicts/lists)\n",
    "    try:\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    \n",
    "    # DYNAMIC GT PATCHES (To map extracted actual text into GT allowing fair evaluation)\n",
    ...
    "\n",
    "            # 3. HANDLE NESTED PREDICTION LISTS\n",
...
print(f"✅ nb4_eval.ipynb has been successfully rewritten with the robust fixes.")
