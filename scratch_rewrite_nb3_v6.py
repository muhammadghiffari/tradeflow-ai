"""
Rewrite nb3 with the CORRECT model class: Qwen2_5_VLForConditionalGeneration
(not Qwen2VLForConditionalGeneration). 

allenai/olmOCR-2-7B-1025 is a Qwen2.5-VL architecture, not Qwen2-VL.
Using the wrong class causes all visual encoder weights to be MISSING/UNEXPECTED,
leading to bitsandbytes AssertionError on randomly-initialized layers.
"""
import json
...
nb3 = {
 "cells": [
  ...
  {"cell_type":"markdown","metadata":{},"source":["## 1. Load Model (Qwen2.5-VL + 4-bit NF4 + LoRA r=32)"]},
  {"cell_type":"code","execution_count":None,"metadata":{},"outputs":[],"source":[
    ...
    "\n",
    "# Use AutoModelForVision2Seq to auto-detect the correct class (Qwen2_5_VLForConditionalGeneration)\n",
  ...
  {"cell_type":"markdown","metadata":{},"source":["## 3. Custom Data Collator (Qwen2.5-VL Multimodal)"]},
  {"cell_type":"code","execution_count":None,"metadata":{},"outputs":[],"source":[
...
print("nb3 rewritten with AutoModelForVision2Seq (auto-detects Qwen2.5-VL)")
